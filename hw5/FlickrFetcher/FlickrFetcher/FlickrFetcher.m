...
+ (NSArray *)photoForTags:(NSString *)tags {
  NSString *request = [NSString stringWithFormat:@"http://api.flickr.com/services/rest/?method=flickr.photos.search&sort=interestingness-desc&content_type=1&tags=%@", tags];
  return [[self executeFlickrFetch:request] valueForKeyPath:@"photos.photo"];
}
